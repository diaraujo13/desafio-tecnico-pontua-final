...
import { createUserUseCase } from '../../main/container';
...
/**
 * Hook for creating a new user using TanStack Query Mutation
 *
...
export function useCreateUser() {
  ...
  const createUser = async (dto: CreateUserDTO): Promise<Result<void>> => {
    try {
